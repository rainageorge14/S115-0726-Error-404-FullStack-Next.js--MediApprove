...
export default function ReportsPage() {
  const { medicines, actionLogs, formatTime } = useMedicines();
...
Generated On  : ${formatTime(rpt.generatedOn)}
Status        : ${rpt.status}
-----------------------------------------
                    ...
                    {currentReports.map((rpt) => (
                      <tr key={rpt.id} className="hover:bg-slate-50/50 transition-colors group">
                        ...
                        <td className="px-5 py-3.5">
                          ...
                          <div className="text-[10px] text-slate-400 font-semibold mt-0.5">{formatTime(rpt.generatedOn).split(", ")[0]}</div>
                        </td>
